...
public class ExpenseService {
    ...
    public Expense findById(Long id) {
        return expenseRepository.findById(id)
                .orElseThrow(
                        () -> new EntityNotFoundException("Sorry, the content you are looking for does not exist."));
    }

    /**
     * Retrieves a Page of Expense objects sorted by their creation date in
     * descending order.
     *
     * The provided Pageable object determines the page number, page size, and any
     * additional sorting or filtering options.
     * It is to ensure that each new expense added will stack on top.
     *
     * @param pageable The Pageable object specifying the page number, page size,
     *                 and sorting preferences.
     * @return A Page containing a list of Expense objects sorted by their creation
    ...
    /**
     * Estimates the total amount of expenses from the given Iterable of Expense
     * objects.
     *
    ...
    /**
     * Retrieves a Page of Expense objects filtered by year, month, and expense
     * type.
     *
     * This method queries the expense repository to retrieve expenses within the
     * specified year and month,
     * belonging to the given expense type. The results are ordered by creation date
     * in descending order.
     *
     ...
     * @param page        The Pageable object specifying the desired page and page
     *                    size.
    ...
    public Page<Expense> getExpensesByYearMonthAndType(int year, Month month, String expenseType, Pageable page) {
        ...
        return expenseRepository.findByDateBetweenAndExpenseTypeOrderByCreationDateDesc(startDate, endDate, expenseType,
                page);
    }
     ...
     *
     * This method queries the expense repository to retrieve expenses of the
     ...
     * For a high number of records, it would be ineffective to convert all to
     * String and hold in memory.
     * But for the case of simplicity, I wrote the code in this way since I am
     * dealing with a little amount of data.
     *
     * This method iterates through the collection of Expense objects and formats
     * them into
     * a CSV format, including the Id, Name of Expense, Type of Expense, Amount,
    ...
    public String convertToCSV(Iterable<Expense> expenses) {
        ...
        expensesAsCSV.append("Id,Name of Expense,Type of expense,Amount (Rs),Date,Creation Timestamp\n");

        // Create a NumberFormat for Indian Rupees
